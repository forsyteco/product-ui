import{r as d,j as e}from"./iframe-AG0x1wfB.js";import{d as t}from"./dayjs.min-B680eljq.js";import{B as m}from"./button-6K6P1vdS.js";import{C as i,a as l,b as c,c as p,d as f}from"./card-JpSH4wIV.js";import{C as o}from"./calendar-DxAaJl5e.js";import"./preload-helper-DEha_CyH.js";import"./tailwind-BykweIWy.js";import"./clsx-B-dksMZM.js";import"./spinner-D6GyDD6x.js";import"./index-B8k91cqS.js";import"./chevron-left-DWTTAgxF.js";import"./createLucideIcon-CCX5DxSE.js";import"./chevron-right-C_55WE6O.js";const S={title:"Components/Calendar/Examples",component:o,parameters:{layout:"padded"}},r={render:()=>{const[a,s]=d.useState(),n=a?.from&&a?.to?`${t(a.from).format("DD MMM YYYY")} – ${t(a.to).format("DD MMM YYYY")}`:a?.from?`${t(a.from).format("DD MMM YYYY")} – …`:"Select a date range";return e.jsxs(i,{className:"w-fit",children:[e.jsx(l,{children:e.jsx(c,{children:"Booking dates"})}),e.jsx(p,{className:"p-0",children:e.jsx(o,{mode:"range",selected:a,onSelect:s,numberOfMonths:2})}),e.jsxs(f,{className:"justify-between gap-2",children:[e.jsx("div",{className:"text-base text-muted-foreground",children:n}),e.jsx(m,{variant:"outline",size:"sm",children:"Clear"})]})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => {
