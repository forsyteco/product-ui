import{r as d,j as e}from"./iframe-BVZI3cAm.js";import{d as t}from"./dayjs.min-CnZcEwHr.js";import{B as m}from"./button-CFMYvpAs.js";import{C as i,a as l,b as c,c as p,d as f}from"./card-BGxqojLA.js";import{C as o}from"./calendar-BbzO9zso.js";import"./preload-helper-DEha_CyH.js";import"./tailwind-BykweIWy.js";import"./clsx-B-dksMZM.js";import"./spinner-CPcSxYrz.js";import"./index-B8k91cqS.js";import"./chevron-left-DWs0Wb38.js";import"./createLucideIcon-DpRcIdcj.js";import"./chevron-right-BjkWObBw.js";const S={title:"Components/Calendar/Examples",component:o,parameters:{layout:"padded"}},r={render:()=>{const[a,s]=d.useState(),n=a?.from&&a?.to?`${t(a.from).format("DD MMM YYYY")} – ${t(a.to).format("DD MMM YYYY")}`:a?.from?`${t(a.from).format("DD MMM YYYY")} – …`:"Select a date range";return e.jsxs(i,{className:"w-fit",children:[e.jsx(l,{children:e.jsx(c,{children:"Booking dates"})}),e.jsx(p,{className:"p-0",children:e.jsx(o,{mode:"range",selected:a,onSelect:s,numberOfMonths:2})}),e.jsxs(f,{className:"justify-between gap-2",children:[e.jsx("div",{className:"text-base text-muted-foreground",children:n}),e.jsx(m,{variant:"outline",size:"sm",children:"Clear"})]})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => {
