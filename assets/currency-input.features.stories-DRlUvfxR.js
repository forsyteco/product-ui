import{r as n,j as e}from"./iframe-Bsx-Ou2Z.js";import{C as t}from"./currency-input-CEaMgs6J.js";import"./preload-helper-DEha_CyH.js";import"./input-DtwKD-cU.js";import"./index-B8k91cqS.js";import"./clsx-B-dksMZM.js";const v={title:"Components/CurrencyInput/Features",component:t,parameters:{layout:"centered"}},a={render:()=>{const[l,s]=n.useState(),[r,u]=n.useState(5),[c,m]=n.useState(1234.56);return e.jsxs("div",{className:"space-y-4 w-72",children:[e.jsxs("div",{className:"space-y-1",children:[e.jsx("p",{className:"text-sm text-muted-foreground",children:"Default (2 decimals)"}),e.jsx(t,{placeholder:"Enter amount",value:l,onValueChange:s,currencySymbol:"£"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx("p",{className:"text-sm text-muted-foreground",children:"Clamped between 0 and 10"}),e.jsx(t,{value:r,onValueChange:u,min:0,max:10,decimalScale:2,currencySymbol:"$"})]}),e.jsxs("div",{className:"space-y-1",children:[e.jsx("p",{className:"text-sm text-muted-foreground",children:"Different locale (fr-FR)"}),e.jsx(t,{value:c,onValueChange:m,locale:"fr-FR",decimalScale:2,currencySymbol:"€"})]})]})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: () => {
