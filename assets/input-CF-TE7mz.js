...
Omit<ComponentPropsWithoutRef<'a'>, keyof IconOnlyButtonBaseProps | 'as' | 'children'> & {
  ...
  as: 'a';
  href: string;
}`,signature:{properties:[{key:"as",value:{name:"literal",value:"'a'",required:!0}},{key:"href",value:{name:"string",required:!0}}]}}]}]},description:""}}};function Tn(e){return e.format==="currency"}function Bn(e){return Tn(e)?g.jsx(we,{...e}):g.jsx(U,{...e})}Bn.__docgenInfo={description:"",methods:[],displayName:"Input"};export{Bn as I};
