...
const defaultBreakpoints = ['544px', '768px', '1012px', '1280px']
export const Breakpoints = {
  xsmall: { width: '320px' },
  small: { width: defaultBreakpoints[0] },
  medium: { width: defaultBreakpoints[1] },
  large: { width: defaultBreakpoints[2] },
  xlarge: { width: defaultBreakpoints[3] },
