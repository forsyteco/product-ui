import{r as m,j as e}from"./iframe-C3NiGLkr.js";import{d as t}from"./dayjs.min-B8cLjufS.js";import{B as i}from"./button-FF05ASSK.js";import{C as l,a as c,b as f,c as p,d as C}from"./card-UK-og6_2.js";import{C as o}from"./calendar-CPK6Qk2a.js";import"./preload-helper-DEha_CyH.js";import"./index-cXaQtA9H.js";import"./tailwind-CDN07tui.js";import"./chevron-left-CBXn69kJ.js";import"./createLucideIcon-pDlEEtuN.js";import"./chevron-right-DWQkbNt4.js";const k={title:"Components/Calendar/Examples",component:o,parameters:{layout:"padded"}},r={render:()=>{const[a,s]=m.useState(),n=a?.from&&a?.to?`${t(a.from).format("DD MMM YYYY")} – ${t(a.to).format("DD MMM YYYY")}`:a?.from?`${t(a.from).format("DD MMM YYYY")} – …`:"Select a date range";return e.jsxs(l,{className:"w-fit",children:[e.jsx(c,{children:e.jsx(f,{children:"Booking dates"})}),e.jsx(p,{className:"p-0",children:e.jsx(o,{mode:"range",selected:a,onSelect:d=>s(d),numberOfMonths:2})}),e.jsxs(C,{className:"justify-between gap-2",children:[e.jsx("div",{className:"text-base text-muted-foreground",children:n}),e.jsx(i,{variant:"outline",size:"sm",children:"Clear"})]})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => {
