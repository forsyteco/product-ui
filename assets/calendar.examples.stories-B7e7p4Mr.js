import{r as m,j as e}from"./iframe-2gSw_mv2.js";import{d as t}from"./dayjs.min-Cu22OzAV.js";import{B as i}from"./button-CJEJXt86.js";import{C as l,a as c,b as p,c as f,d as C}from"./card-CHbb2xeL.js";import{C as o}from"./calendar-BtGj8AdV.js";import"./preload-helper-DEha_CyH.js";import"./tailwind-BykweIWy.js";import"./clsx-B-dksMZM.js";import"./spinner-mOKOfvx7.js";import"./index-B8k91cqS.js";import"./chevron-left-NHq9S6pJ.js";import"./createLucideIcon-DBgTOM77.js";import"./chevron-right-BVoF0DKj.js";const S={title:"Components/Calendar/Examples",component:o,parameters:{layout:"padded"}},r={render:()=>{const[a,s]=m.useState(),n=a?.from&&a?.to?`${t(a.from).format("DD MMM YYYY")} – ${t(a.to).format("DD MMM YYYY")}`:a?.from?`${t(a.from).format("DD MMM YYYY")} – …`:"Select a date range";return e.jsxs(l,{className:"w-fit",children:[e.jsx(c,{children:e.jsx(p,{children:"Booking dates"})}),e.jsx(f,{className:"p-0",children:e.jsx(o,{mode:"range",selected:a,onSelect:d=>s(d),numberOfMonths:2})}),e.jsxs(C,{className:"justify-between gap-2",children:[e.jsx("div",{className:"text-base text-muted-foreground",children:n}),e.jsx(i,{variant:"outline",size:"sm",children:"Clear"})]})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => {
