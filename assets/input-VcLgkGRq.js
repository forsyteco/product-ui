import{r as q,j as y}from"./iframe-B_2llF5Y.js";import{c as $}from"./clsx-B-dksMZM.js";import{r as K}from"./field-autofill-props-Dh75dEkE.js";import{u as Y,b as J,c as Q,r as S,S as X,o as Z,m as ee,d as ne,q as ae,e as re,f as te,z as ie,D as le,ab as se,g as oe,i as ue}from"./input-shell-YTGH2IZD.js";import{B as me}from"./button-YhwC3Rez.js";const R=2,A=e=>e.replace(/,/g,"");function x(e,n="en-GB",a=R,r=0){return e==null?"":new Intl.NumberFormat(n,{minimumFractionDigits:r,maximumFractionDigits:a}).format(e)}function ce(e,n="en-GB",a=R){const r=A(e);if(r==="")return"";const t=r.includes("."),[l,m=""]=r.split("."),i=l.replace(/\D/g,""),s=i?new Intl.NumberFormat(n,{maximumFractionDigits:0}).format(Number(i)):"";if(!t)return s;const k=m.replace(/\D/g,"").slice(0,a);return s===""&&k===""?".":`${s===""?"0":s}.${k}`}function E(e){if(e==null||e==="")return;const n=typeof e=="number"?e:Number(e);return Number.isNaN(n)?void 0:n}function pe(e,n){return e.includes(".")?Math.min(e.split(".")[1]?.length??0,n):0}function F(e,n){const a=A(e),r=pe(a,n);if(a===""||a===".")return{sanitized:a,parsed:void 0,decimals:0};const t=Number(a);return{sanitized:a,parsed:Number.isNaN(t)?void 0:t,decimals:r}}function H(e,n,a){const r=E(n),t=E(a),l=r===void 0?e:Math.max(e,r);return t===void 0?l:Math.min(l,t)}const de=R,ve=q.forwardRef(function(n,a){const{render:r,className:t,id:l,name:m,value:i,disabled:s=!1,onValueChange:k,defaultValue:h,autoFocus:d=!1,style:N,...P}=n,{state:V,name:g,disabled:o,setTouched:v,setDirty:f,validityData:c,setFocused:w,setFilled:p,validationMode:I,validation:b}=Y(),T=o||s,M=g??m,L={...V,disabled:T},{labelId:_}=J(),O=Q({id:l});S(()=>{const u=i!=null;b.inputRef.current?.value||u&&i!==""?p(!0):u&&i===""&&p(!1)},[b.inputRef,p,i]);const B=q.useRef(null);S(()=>{d&&B.current===X(Z(B.current))&&w(!0)},[d,w]);const[U]=ee({controlled:i,default:h,name:"FieldControl",state:"value"}),D=i!==void 0,j=D?U:void 0,G=ne(()=>b.inputRef.current?.value);return ae(b.inputRef,O,j,G),re("input",n,{ref:[a,B],state:L,props:[{id:O,disabled:T,name:M,ref:b.inputRef,"aria-labelledby":_,autoFocus:d,...D?{value:j}:{defaultValue:h},onChange(u){const C=u.currentTarget.value;k?.(C,te(ie,u.nativeEvent)),f(C!==c.initialValue),p(C!=="")},onFocus(){w(!0)},onBlur(u){v(!0),w(!1),I==="onBlur"&&b.commit(u.currentTarget.value)},onKeyDown(u){u.currentTarget.tagName==="INPUT"&&u.key==="Enter"&&(v(!0),b.commit(u.currentTarget.value))}},b.getInputValidationProps(),P],stateAttributesMapping:le})}),ye=q.forwardRef(function(n,a){return y.jsx(ve,{ref:a,...n})}),ge={variant:"ghost",size:"sm",shape:"square"};function z({ref:e,className:n,inputClassName:a,type:r,leadingVisual:t,trailingVisual:l,trailingAction:m,size:i="default",error:s,success:k,"aria-invalid":h,disabled:d,autoComplete:N,...P}){const V=s===!0,g=m?y.jsx(fe,{...m}):void 0,o=!!(g??l);return y.jsx(se,{className:n,size:i,error:V,success:k,leadingVisual:t,trailingVisual:m?void 0:l,trailingAction:g,children:y.jsx(ye,{...P,...K({autoComplete:N}),ref:e,type:r,disabled:d,"aria-invalid":V?!0:h,"data-slot":"input",className:oe({hasLeadingVisual:!!t,hasTrailingVisual:o,inputClassName:a})})})}function fe({className:e,...n}){return y.jsx(me,{...ge,...n,className:$(ue["slot-action-button"],e)})}z.__docgenInfo={description:"",methods:[],displayName:"TextInput",props:{ref:{required:!1,tsType:{name:"ReactRef",raw:"React.Ref<HTMLInputElement | null>",elements:[{name:"union",raw:"HTMLInputElement | null",elements:[{name:"HTMLInputElement"},{name:"null"}]}]},description:""},className:{required:!1,tsType:{name:"string"},description:""},leadingVisual:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Decorative or non-interactive leading content (e.g. icon, flag)."},trailingVisual:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Decorative or non-interactive trailing content (e.g. spinner)."},trailingAction:{required:!1,tsType:{name:"union",raw:"IconOnlyButtonAsButton | IconOnlyButtonAsAnchor",elements:[{name:"intersection",raw:`IconOnlyButtonBaseProps &
